...
dimension: bookingvscollectioncategory {
  ...
  dimension: bookingvscollectioncategory2 {
    ...
    sql:
      ...
      when ${bookingvscollection} is null then 'not allocated'
      when ${bookingvscollection} = 0 then 'on time'
      when ${bookingvscollection} >= 1 and when ${bookingvscollection} <= 15 then '<=15 min late'
      when ${bookingvscollection} <= -1 and when ${bookingvscollection} >= -15 then '<=15 min early'
      when ${bookingvscollection} >= 15 and when ${bookingvscollection} <= 30 then '15-30 min late'
      when ${bookingvscollection} <= -15 and when ${bookingvscollection} >= -30 then '15-30 min early'
      when ${bookingvscollection} >= 30 and when ${bookingvscollection} <= 45 then '30-45 min late'
      when ${bookingvscollection} <= -30 and when ${bookingvscollection} >= -45 then '30-45 min early'
      when ${bookingvscollection} >= 45 and when ${bookingvscollection} <= 60 then '45-60 min late'
      when ${bookingvscollection} <= -45 and when ${bookingvscollection} >= -60 then '45-60 min early'
      when ${bookingvscollection} >= 60 and when ${bookingvscollection} <= 75 then '60-75 min late'
      when ${bookingvscollection} <= -60 and when ${bookingvscollection} >= -75 then '60-75 min early'
      when ${bookingvscollection} >= 75 and when ${bookingvscollection} <= 90 then '75-90 min late'
      when ${bookingvscollection} <= -75 and when ${bookingvscollection} >= -90 then '75-90 min early'
      when ${bookingvscollection} >= 90 and when ${bookingvscollection} <= 105 then '90-105 min late'
      when ${bookingvscollection} <= -90 and when ${bookingvscollection} >= -105 then '90-105 min early'
      when ${bookingvscollection} >= 105 and when ${bookingvscollection} <= 120 then '105-120 min late'
      when ${bookingvscollection} <= -105 and when ${bookingvscollection} >= -120 then '105-120 min early'
      when ${bookingvscollection} >= 120 and when ${bookingvscollection} <= 135 then '120-135 min late'
      when ${bookingvscollection} <= -120 and when ${bookingvscollection} >= -135 then '120-135 min early'
      when ${bookingvscollection} >= 135 and when ${bookingvscollection} <= 150 then '135-150 min late'
      when ${bookingvscollection} <= -135 and when ${bookingvscollection} >= -150 then '135-150 min early'
      when ${bookingvscollection} >= 150 and when ${bookingvscollection} <= 165 then '150-165 min late'
      when ${bookingvscollection} <= -150 and when ${bookingvscollection} >= -165 then '150-165 min early'
      when ${bookingvscollection} >= 165 and when ${bookingvscollection} <= 180 then '165-180 min late'
      when ${bookingvscollection} <= -165 and when ${bookingvscollection} >= -180 then '165-180 min early'
      when ${bookingvscollection} >= 180 and when ${bookingvscollection} <= 195 then '180-195 min late'
      when ${bookingvscollection} <= -180 and when ${bookingvscollection} >= -195 then '180-195 min early'
      when ${bookingvscollection} >= 195 and when ${bookingvscollection} <= 210 then '195-210 min late'
      when ${bookingvscollection} <= -195 and when ${bookingvscollection} >= -210 then '195-210 min early'
